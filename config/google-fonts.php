...
return [
     ...
     */
    'fonts' => [
        // Primary UI font only — trimmed weights used across the site.
        'default' => 'https://fonts.googleapis.com/css2?family=Figtree:ital,wght@0,400;0,500;0,600;0,700;1,400;1,600&display=swap',
    ],
